module.exports = {
    ...
    好词好句: [
        '动态类型一时爽，代码重构火葬场----------typeScript 必学'
    ],
    架构心得: [
        '后端接口，异常时，非线上环境，输出到页面隐藏域，输出到控制台',
        '开始用 typescript 吧，排除静态类型的问题',
        '响应式布局',
        'svg 自建字体'
    ],
    ...
    wait: [
        ...
        '移动端适配：https://juejin.im/post/5cddf289f265da038f77696c',
        {
            ...
            响应式布局: [
                'https://mp.weixin.qq.com/s?__biz=MzUyODMzMjY3OQ==&mid=2247484206&idx=1&sn=d26bef15fdb533a5d7c717a6fb0bed57&chksm=fa70a1c6cd0728d075c92374b189682b6ce3fdd3918d20985d01e01a0b860df68b04eb5221c1&scene=0&xtrack=1#rd',
                'https://mp.weixin.qq.com/s?__biz=MzUyODMzMjY3OQ==&mid=2247484225&idx=1&sn=0bb36a15a81b5bac09b0da54373f66e7&chksm=fa70a1a9cd0728bf730cab3949abb42254a3edc16435e13a788d6e8dc3aded4b3fbd011cc463&scene=0&xtrack=1#rd'
            ],
            promise: [
                'https://github.com/forthealllight/blog/issues/4'
            ],
            react: [
                'typescript https://juejin.im/post/5ce24f8ae51d45106477bd45',
